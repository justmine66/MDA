...
namespace EBank.ApiServer.Infrastructure.ModelValidations
{
    ...
    public class GreaterThanAndEqualAttribute : ValidationAttribute
    {
        /// <summary>
        /// 下限
        /// </summary>
        ...
        /// <summary>
        /// 初始化 <see cref="GreaterThanAndEqualAttribute"/> 对象。
        /// </summary>
        /// <param name="lowerLimit">下限</param>
        public GreaterThanAndEqualAttribute(short lowerLimit)
        {
        ...
        /// </summary>
        /// <param name="lowerLimit">下限</param>
        public GreaterThanAndEqualAttribute(ushort lowerLimit)
        {
            LowerLimit = lowerLimit;
        }
        ...
        /// </summary>
        /// <param name="lowerLimit">下限</param>
        public GreaterThanAndEqualAttribute(int lowerLimit)
        {
            LowerLimit = lowerLimit;
        }
        ...
        /// </summary>
        /// <param name="lowerLimit">下限</param>
        public GreaterThanAndEqualAttribute(uint lowerLimit)
        {
            LowerLimit = lowerLimit;
        }
        ...
        /// </summary>
        /// <param name="lowerLimit">下限</param>
        public GreaterThanAndEqualAttribute(long lowerLimit)
        {
            LowerLimit = lowerLimit;
        }
        ...
        /// </summary>
        /// <param name="lowerLimit">下限</param>
        public GreaterThanAndEqualAttribute(ulong lowerLimit)
        {
            LowerLimit = lowerLimit;
        }
        ...
        /// </summary>
        /// <param name="lowerLimit">下限</param>
        public GreaterThanAndEqualAttribute(float lowerLimit)
        {
            LowerLimit = lowerLimit;
        }
        ...
        /// </summary>
        /// <param name="lowerLimit">下限</param>
        public GreaterThanAndEqualAttribute(double lowerLimit)
        {
            LowerLimit = lowerLimit;
        }
        ...
        /// </summary>
        /// <param name="lowerLimit">下限</param>
        public GreaterThanAndEqualAttribute(decimal lowerLimit)
        {
            LowerLimit = lowerLimit;
        }
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            switch (typeCode)
            {
                case TypeCode.Int16:
                    ...
                    {
                        return new ValidationResult($"The {validationContext.DisplayName} must be greater than and equal to {LowerLimit}.", new[] { nameof(value) });
                    }
                    break;
