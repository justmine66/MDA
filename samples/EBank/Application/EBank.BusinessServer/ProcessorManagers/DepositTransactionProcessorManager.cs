...
namespace EBank.BusinessServer.ProcessorManagers
{
    ...
    public class DepositTransactionProcessorManager :
        ...
        // 2.1 从银行账户聚合根，收到存款交易验证已通过的领域通知，向存款交易聚合根发起确认。
        IDomainNotificationHandler<DepositTransactionValidatedDomainNotification>,
        ...
        IDomainEventHandler<DepositTransactionSubmittedDomainEvent>
    {
        ...
        /// </summary>
        /// <param name="context">事件处理上下文</param>
        /// <param name="notification">存款交易信息验证已通过的领域通知</param>
        public void OnDomainNotification(IDomainNotifyingContext context, DepositTransactionValidatedDomainNotification notification)
        {
