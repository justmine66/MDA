...
{
    public static class DbConstantsStore
    {
        private static readonly Dictionary<string, DbConstants> InvariantNameToConstants =
        ...
        public static DbConstants GetDbConstants(string invariantName) 
            => InvariantNameToConstants[invariantName];
        ...
        public static bool SupportsCommandCancellation(string adoNetProvider) 
            => GetDbConstants(adoNetProvider).SupportsCommandCancellation;
        ...
        public static bool SupportsStreamNatively(string adoNetProvider) 
            => GetDbConstants(adoNetProvider).SupportsStreamNatively;
        ...
        public static bool IsSynchronousAdoNetImplementation(string adoNetProvider) 
            => GetDbConstants(adoNetProvider).IsSynchronousAdoNetImplementation;
        public static ICommandInterceptor GetDatabaseCommandInterceptor(string invariantName) 
            => GetDbConstants(invariantName).DatabaseCommandInterceptor;
    }
