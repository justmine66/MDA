...
{
    /// <summary>
    /// Contains some convenience methods to use in conjunction with <see cref="IRelationalDbStorage">IRelationalStorage</see> and <see cref="RelationalDbStorage">GenericRelationalStorage</see>.
    /// </summary>
    public static class DbExtensions
    {
        ...
        /// An explicit map of type CLR viz database type conversions.
        /// </summary>
        public static readonly ReadOnlyDictionary<Type, DbType> DbTypeMap = new ReadOnlyDictionary<Type, DbType>(new Dictionary<Type, DbType>
        {
        ...
        public static IDbDataParameter CreateParameter<T>(
            ...
            DbType? dbType = null)
        {
            ...
            parameter.DbType = dbType ?? DbTypeMap[typeof(T)];
        ...
        public static TValue GetValueOrDefault<TValue>(this IDataRecord record, int ordinal, TValue @default = default)
            => record.IsDBNull(ordinal) ? @default : (TValue)record.GetValue(ordinal);
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                return await record.GetFieldValueAsync<TValue>(ordinal, cancellationToken)
            ...
            IReadOnlyDictionary<string, string> nameMap = null)
        {
            ...
            foreach (var t in properties)
            {
                ...
                parameter.ParameterName = nameMap != null && nameMap.ContainsKey(t.Name) ? nameMap[property.Name] : t.Name;
                parameter.DbType = DbTypeMap[property.PropertyType];
