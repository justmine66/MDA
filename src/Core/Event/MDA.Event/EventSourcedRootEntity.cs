...
namespace MDA.Event
{
    ...
    public abstract class EventSourcedRootEntity : EntityWithCompositeId
    {
        ...
        {
            _mutatingEvents = new List<DomainEvent>();
        }
        /// <summary>
        /// 初始化一个 <see cref="EventSourcedRootEntity"/> 实例。
        /// </summary>
        ...
        protected EventSourcedRootEntity(IEnumerable<DomainEvent> eventStream, int streamVersion)
           : this()
        {
        ...
        /// 领域事件列表
        /// </summary>
        private readonly IList<DomainEvent> _mutatingEvents;
        ...
        /// 已变异版本
        /// </summary>
        protected int MutatedVersion => _unMutatedVersion + 1;
        ...
        /// </summary>
        /// <returns></returns>
        public IList<DomainEvent> GetMutatingEvents()
        {
